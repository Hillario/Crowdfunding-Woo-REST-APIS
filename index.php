...
<body>
  ...
  <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
    ...
    <!-- Input for Feature Image/Video -->
    <div class="form-group">
      <label for="featureImage">Feature Image/Video:</label>
      <input type="file" class="form-control-file mb-3" id="featureImage">
      <small id="featureImageHelp" class="form-text text-muted">Click or drag file to this area to upload.</small>
    </div>

    <!-- Input for Gallery Images -->
    <div class="form-group">
      <label for="galleryImages">Gallery Images:</label>
      <input type="file" class="form-control-file mb-3" id="galleryImages" multiple>
      <small id="galleryImagesHelp" class="form-text text-muted">Click or drag file to this area to upload.</small>
    </div>
